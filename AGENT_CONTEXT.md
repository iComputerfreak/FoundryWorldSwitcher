...
- Disabling Foundry features cancels active bookings, unqueues their events, removes global conflicts, and releases matching booking-owned world locks. Scheduler also ignores stale booking lock and reminder events from disabled guilds; cleanup unlock events still run.
