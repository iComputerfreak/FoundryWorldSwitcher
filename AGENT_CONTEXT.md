...
- `/book event` parses dates as `dd.MM.yyyy` and times as `HH:mm`; it stores campaign role, optional voice channel, topic, and optional world ID. `/book reservation` stores a date and required world ID for preparation.
